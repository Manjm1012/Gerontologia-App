...
- **Nombre**: Selector de Usuarios registrados en el sistema
...
Si no hay Usuarios en el sistema, crear algunos usando el formulario de historia gerontológica o desde el shell:
