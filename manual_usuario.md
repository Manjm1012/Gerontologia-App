...
- URL asociadas (según las plantillas y convenciones del proyecto):
  ...
  - Panel/Empleados → `lista_Empleados.html` / `formulario_usuario.html` / `confirmar_borrado_usuario.html`
  - `/servicios` → `servicios.html`
  - `/somos` → `Somos.html`
...
- **`administrador.html`, `lista_Empleados.html`, `formulario_usuario.html`, `confirmar_borrado_usuario.html`**:
  - URL: rutas de administración de Empleados (panel interno).
  - Uso: crear/editar/listar/borrar Empleados; `formulario_usuario.html` tiene campos para username, email, nombres, roles.
  - Capturas sugeridas: `docs/images/administrador.png`, `docs/images/lista_Empleados.png`, `docs/images/formulario_usuario.png`, `docs/images/confirmar_borrado.png`.
...
- **`enfermeria.html`**:
  - URL: `/enfermeria`
  - Uso: módulo específico para Empleados con perfil de enfermería. Incluye dashboard con estadísticas del día, acciones rápidas (registro de signos vitales, control de medicamentos, notas de enfermería), tabla de Usuarios del día y alertas/recordatorios.
  - Acceso: solo Empleados del grupo "Enfermeria" pueden acceder.
...
- `docs/images/` → colocar todas las capturas: `index.png`, `login.png`, `registro.png`, `servicios.png`, `contactenos.png`, `historia_gerontologica.png`, `paciente.png`, `administrador.png`, `lista_Empleados.png`, `dashboard.png`, `terminos.png`, `somos.png`.
...
**Archivos esperados**
`index.png, login.png, registro.png, servicios.png, especialidades.png, atencion.png, contactenos.png, historia_gerontologica.png, paciente.png, administrador.png, lista_Empleados.png, formulario_usuario.png, confirmar_borrado.png, dashboard.png, terminos.png, somos.png, enfermeria.png`
...
![Lista Empleados](docs/images/lista_Empleados.png)
